...
public class StanfordSeg {
	...
	{
		String ansi_seg=segStanford(text);
		String mseg=merge_sen_limit(ansi_seg,4);
	...
	public String segStanford(String text) {
		String segs = "";
        segs =classifier.classifyToString(text);
		return segs;
	}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("segt:"+stanfseg.seg(text));
	
		
		text="赛达笔记本小音箱电脑多媒体迷你音箱usb低音炮音响包邮-tmall.com天猫";
		System.out.println("text:"+text);
		System.out.println("segt:"+stanfseg.seg(text));
