package org.jmlp.file.utils;

import java.io.PrintWriter;

import org.jmlp.perceptron.ShuffleArray;
...
public class FileSplit {
	...
	public static void splitRandom(double trp,String input_file,String trfile,String tefile) throws Exception
	{
         ...
         * @throws Exception
         */
        public static void splitRandomSim(double trp,String input_file,String trfile,String tefile) throws Exception
        {
                String[] input_arr=FileToArray.fileToDimArr(input_file);
                double rand=0;
                ShuffleArray.shuffleStrs(input_arr);
                ...
                for(int i=0;i<input_arr.length;i++)
                {
                        ...
                        if(rand<trp)
                        {
                                 trpw.println(input_arr[i].trim());
                        }
                        else
                        {
                                tepw.println(input_arr[i].trim());
                        }
                }
	...
	public static void main(String[] args) throws Exception
	{
		...
		splitParts(tefile,tesplit_dir,20);
               */
                ...
                if(args.length!=4)
                {
                    System.out.println("Usage:<trp> <input_file> <train_file> <test_file>");
                    System.exit(1);
                }

                String input_file=args[1];
                String trfile=args[2];
                String tefile=args[3];
                double trp=Double.parseDouble(args[0]);
                splitRandomSim(trp,input_file,trfile,tefile);
