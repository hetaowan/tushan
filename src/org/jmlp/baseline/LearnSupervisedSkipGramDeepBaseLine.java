...
import com.ansj.vec.ClassifySupervised;
import com.ansj.vec.Learn;
import com.ansj.vec.LearnSupervisedSkipGramDeep;
...
public class LearnSupervisedSkipGramDeepBaseLine {
	...
	public LearnSupervisedSkipGramDeepBaseLine(Boolean isCbow, Integer layerSize,
	...
	public LearnSupervisedSkipGramDeepBaseLine() {
		createExpTable();
	}
	...
	public void trainOneDocUnsupervised(String recLine) {
		...
		for (int index = 0; index < sentence.size(); index++) {
			...
			// skipGramRaw(index, sentence, labelWN, (int) nextRandom % window);
			skipGramRaw(index, sentence, labelWN, (int) nextRandom % window);
			//cbowGramRaw( index, sentence, labelWN, (int) nextRandom % window);
		}
	 ...
	 * @param neu1
	 */
	private void skipGramRaw(int index, List<WordNeuron> sentence,
	...
	public static void main(String[] args) throws IOException {
		LearnSupervisedSkipGramDeepBaseLine learn = new LearnSupervisedSkipGramDeepBaseLine();
