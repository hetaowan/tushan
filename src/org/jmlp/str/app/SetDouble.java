...
public class SetDouble {
	...
	public void init_second() {
		try {
			...
			second_classifier.loadClassifierNoExceptions("models/trainbeq.gz",
					props);
	...
	public String segc(String s) throws Exception {
		s = s.trim();
		s = s + "\n";
		String seg_s = "";
	...
	public static void main(String[] args) throws Exception {
		FileWriter fw = new FileWriter(new File("testdouble2.txt"));
		PrintWriter pw = new PrintWriter(fw);

		SetDouble sd = new SetDouble();
		sd.init_first();
		sd.init_second();
		...
		String[] strs = {
				...
				"2013年秋天，习近平主席分别提出建设丝绸之路经济带和21世纪海上丝绸之路的战略构想。贯穿欧亚大陆，东连亚太经济圈，西入欧洲经济圈。世界上跨度最长的经济大走廊，最具发展潜力的经济合作带……“一带一路”，应者云集，世界瞩目。",
				"习近平欢迎拉赫蒙总统来华出席加强互联互通伙伴关系对话会。习近平指出，中塔是好邻居、好朋友、好兄弟，两国战略伙伴关系有着广泛、坚实的民意基础。今年9月，我对塔吉克斯坦进行国事访问期间，同你达成一系列重要共识，我们商定的一批大型合作项目正在有序推进。我愿意同你继续保持密切接触，为两国合作作出规划并推动落实。下一步，双方要挖掘潜力，以能源、交通、农业等领域为重点，积极探讨新的合作模式，共同开展加工生产，使两国合作向更高水平、更高层次迈进。中方支持塔方希望成为中国同中亚及海湾国家经贸往来过境运输通道的愿望，将同塔方加快推进互联互通合作，共同推进丝绸之路经济带建设。两国执法安全部门要密切配合，加强网络反恐和禁毒合作，并同阿富汗等有关各方一道，携手打击“三股势力”。"};
		...
		String[] strs={"2013春秋装新款女装韩版甜美修身长袖雪纺连衣裙 翻领雪纺女裙子",
				...
				"2013秋冬装新款ShuLier8818可拆卸 貉子毛领裙摆式毛呢大衣外套",
				"秋冬季黑色韩版绒面单靴 平底女靴子高筒弹力靴过膝长靴女鞋二棉",
				"2013真皮粗跟头层牛皮单鞋女鞋圆头中跟水钻蝴蝶结浅口黑色低帮鞋",
				"赚人气3支包邮自制可以吃的护唇膏超保湿防干裂/任何人都可以用",
				"美国Crayola绘儿乐 16色可水洗短杆水笔-造型笔尖 58-8709",
				"特价秋冬新款女T恤长袖修身加厚保暖打底衫海狸绒气质淑女休闲",
				"制谱，打谱，简谱、五线谱制作、声乐钢琴伴奏谱移调2",
				"2013冬季新款女棉鞋 真皮羊毛中跟短靴大码妈妈鞋女棉靴子35-43码-tmall.com天猫",
				"包邮专柜正品旁氏无瑕透白精致凝白水润霜女士面霜保湿补水美白",
				"2013秋冬款包臀性感淑女A字裙OL通勤连衣裙夏赫本风连衣裙夏",
				"结婚喜糖盒 创意喜糖盒子 婚庆用品 大号马口铁盒  可批发定制",
				"换季清仓 Polo 斯文细条纹柔软舒适薄棉男士翻领T恤（2色）",
				"真能超轻水植物精油眼部活力紧致精华 淡纹 去黑眼圈眼袋 保湿",
				"深圳红玫瑰鲜花速递深圳沙井福永松岗南山宝安龙岗罗湖福田鲜花店",
				"ochirly fiveplus服装　Ｔ恤　马夹　特价商品绝对正品专柜验货",
				"2013新款女装秋装连衣裙 秋冬长袖修身韩版潮 新品中长款打底裙",
				"2013冬allo lugh原单正品小狐狸白毛毛马甲+长袖t恤2件套",
				"amyy/定制款藏青色羊毛呢双排扣大衣 限时折扣 预定一周",
				"特价 欧美包臀V领性感夜店豹纹修身长袖裹胸连衣裙2013秋新款女",
				"复古vintage撞色翻领彼得潘娃娃领兔毛修身套头毛衣女",
				"带光带灯发光兔耳朵发箍套装兔子头箍发卡发饰品兔女郎 跳舞道具",
				"秋冬裸靴中筒靴女靴子欧美复古高跟鞋冬中靴粗跟马丁靴防水台女鞋",
				"10件包邮韩版家居清新可爱糖果色五角星收纳袋购物袋大容量手提袋",
				"资生堂UNO吾诺男士洗面奶控油/保湿/磨砂洁面乳130g 台湾版",
				"2013秋季韩国新款学院风五角星铆钉长袖前短后长卫衣套头衫",
				"正品美国辉瑞卫佳五联疫苗5联4联卫佳四联（宠物医院）狗狗疫苗",
				"送男友老公首选 包邮双拼男士风格全棉床上用品 床单式纯棉四件套",
				"正品太阳眼镜男士女士太阳眼镜驾驶眼镜蛤蟆镜墨镜男太阳镜 代购",
				"安程腰靠 腰枕靠背 布纹 高档尼龙布沙发腰靠枕 靠垫 防污防腿色"};
		*/		
		//String[] strs={"全国中小学生安全教育活动办公室","望京西站在哪里" ,"11月2日，沈阳地区校友会在省总工会9楼会议室召开了大连工业大学沈阳地区校友会第二届理事会成立大会暨一次工作会议。","希望沈阳地区校友会在以刘野为会长的班子领导下，群策群力，创造性的开展工作，在为学校在校生的就业、招生、实习、产学研合作、为学校教育教学发展服务，聘请更多的沈阳地区校友成为大连工业大学的客座教授。","10月11日上午，中国工程院院士、沈阳航空航天大学校长杨凤田一行到东北局拜会。","小时候在山东，对门的邻居经常做虾酱炒鸡蛋，一小碗，灰灰的颜色，炒的时候腥腥臭臭的，吃的时候很香。1，请问是用什么虾酱？小时候的味道没有那么咸；2，请问海边的做法是怎么做的； "," 各位大侠,CHC高清电影镖行天下之桃花劫和瞒天过海分别在1月31号和2月1号播出,不知有人录制没?...","不怎么样,怀疑药是假的,之前在我们本地的健民大药房买的普适泰片,吃了感觉就有效果,但是后来没货了,只好在康爱多网上药店订,没想到担心的事儿发生了","哥几个将于11.3号录制快乐大本营,四年磨一剑,哥哥们在四年后的现在再次登上快乐大本营的舞台,更加完美,更加成熟。至上励合加油!谢谢大本营","都属于觉罗氏的人,但是家族不一样,觉罗氏包含爱新觉罗家族、伊尔根觉罗家族和其他家族。满族中氏比家族大,但同氏间关系比不同的又近些。"};
		
		//String[] strs={"全国中小学生安全教育活动办公室","望京西站在哪里"};
		...
		for (int i = 0; i < strs.length; i++) {
			...
			try { 
				...
				System.out.println(seg.replaceAll("\\s+", "_"));
				pw.println(seg);
			} catch (Exception e) {
				e.printStackTrace();
			}
