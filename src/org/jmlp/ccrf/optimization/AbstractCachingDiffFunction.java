...
public abstract class AbstractCachingDiffFunction implements DiffFunction, HasInitial {
  ...
  private static Logger logger = Logger.getLogger(AbstractCachingDiffFunction.class);
  ...
  void ensure(double[] x) {
	//logger.info("in AbstractCachingDiffFunction ensure");  
  ...
  public double valueAt(double[] x) {
	//logger.info("in AbstractCachingDiffFunction valueAt");  
    ensure(x);
    return value;
  }
