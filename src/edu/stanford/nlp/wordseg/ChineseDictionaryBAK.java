...
public class ChineseDictionaryBAK {
	...
	public ChineseDictionaryBAK(String dict) {
		this(new String[] { dict });
	}

	public ChineseDictionaryBAK(String[] dicts) {
		this(dicts, null);
	}
	 ...
	 * 
	 **/
	public ChineseDictionaryBAK(String serDicts,
	...
	public static void main(String[] args) {
		...
		ChineseDictionaryBAK dict = new ChineseDictionaryBAK(dicts, cdtos,
				expandMidDot);
