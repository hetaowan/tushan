...
public class PlainTextDocumentReaderAndWriter<IN extends CoreMap> implements DocumentReaderAndWriter<IN> {
  ...
  public void printAnswers(List<IN> l, PrintWriter out,
                           OutputStyle outputStyle, boolean preserveSpacing) {
	//outputStyle=OutputStyle.XML;
	
    switch (outputStyle) {
    case SLASH_TAGS:
      System.out.println("SLASH_TAGS");	
      if (preserveSpacing) {
    	  System.out.println("SLASH_TAGS preserveSpacing");	
        printAnswersAsIsText(l, out);
      } else {
    	  System.out.println("SLASH_TAGS not preserveSpacing");	
        printAnswersTokenizedText(l, out);
      }
      break;
    case XML:
      if (preserveSpacing) {
    	  System.out.println("XML preserveSpacing");	
    ...
    case INLINE_XML:
      if (preserveSpacing) {
    	  System.out.println("INLINE_XML preserveSpacing");	
        printAnswersInlineXML(l, out);
      } else {
    	System.out.println("INLINE_XML not preserveSpacing");	
