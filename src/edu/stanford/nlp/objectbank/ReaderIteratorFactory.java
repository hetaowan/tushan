...
public class ReaderIteratorFactory implements Iterable<Reader> {
  ...
  class ReaderIterator extends AbstractIterator<Reader> {
    ...
    public ReaderIterator() {
     // System.out.println("in in ReaderIterator");
      iter = c.iterator();
      setNextObject();
     // System.out.println("out out ReaderIterator");
    ...
    private void setNextObject() {
     // System.out.println("in set nextobject lll");	
      if (!iter.hasNext()) {
        nextObject = null;
        iter = null;
       // System.out.println("return out the setnext");	
        return;
      }
...
//          }
         ...
         // System.out.println("don't know how to get Reader from");	
     ...
     // System.out.println("out set nextobject");
    }
