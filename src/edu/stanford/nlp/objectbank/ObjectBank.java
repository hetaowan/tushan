...
public class ObjectBank<E> implements Collection<E>, Serializable {
  ...
  public Iterator<E> iterator() {
	 ...
	 // System.out.println("in objectbank iterator");
    ...
    OBIterator obitemp=new OBIterator();
   // System.out.println("out objectbank iterator");
  ...
  class OBIterator extends AbstractIterator<E> {
    ...
    public OBIterator() {
      ...
      //System.out.println("readerIterator:"+readerIterator.getClass().getCanonicalName());
      setNextObject();
     // System.out.println("out readerIterator:"+readerIterator.getClass().getCanonicalName());
    }

    private void setNextObject() {
    	 //System.out.println("test objectbank setNextObject 1");
      ...
      //System.out.println("test objectbank setNextObject 2");
      while (true) {
        try {
          if (currReader != null) {
            currReader.close();
       ...
       // System.out.println("test objectbank setNextObject 3");
        if (readerIterator.hasNext()) {
        	// System.out.println("test objectbank setNextObject 5");
          currReader = readerIterator.next();
          //System.out.println("test objectbank setNextObject 6");
          //System.out.println("ifrf:"+ifrf.getClass().getCanonicalName());
          tok = ifrf.getIterator(currReader);
         // System.out.println("test objectbank setNextObject 7");
        } else {
          nextObject = null;
          return;
        }
       // System.out.println("test objectbank setNextObject 4");
        if (tok.hasNext()) {
          nextObject = tok.next();
          return;
        }
    ...
    @Override
    public E next() {
      //System.out.println("in objectbank next");	
      if (nextObject == null) {
