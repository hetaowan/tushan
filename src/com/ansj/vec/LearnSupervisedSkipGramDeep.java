...
public class LearnSupervisedSkipGramDeep {
	...
	public LearnSupervisedSkipGramDeep(Boolean isCbow, Integer layerSize,
	...
	public LearnSupervisedSkipGramDeep() {
		createExpTable();
	}
	...
	public static void main(String[] args) throws IOException {
		LearnSupervisedSkipGramDeep learn = new LearnSupervisedSkipGramDeep();
		...
		System.out.println(w2v.distance("差"));
		System.out.println(w2v.distance("漂亮"));
		System.out.println(w2v.distance("好"));
