...
public class WordNeuron extends Neuron {
    ...
    public int label;//增加0或1
    public double[] syn21 = null;
    public double[] syn20 = null;
    ...
    public WordNeuron(String name, int freq, int layerSize) {
        ...
        this.syn20 = new double[layerSize];
        this.syn21 = new double[layerSize];
        ...
        /*
        for (int i = 0; i < syn20.length; i++) {
            syn20[i] = (random.nextDouble() - 0.5) / layerSize;
        }
      for (int i = 0; i < syn21.length; i++) {
            syn21[i] = (random.nextDouble() - 0.5) / layerSize;
       }
        */
    }
